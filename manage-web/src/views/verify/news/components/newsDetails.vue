<template>
  <div>
    <verify-detail :detail-id="rowId" :get-detail="getNewsDetail" detailName="newsid" />
    <!-- 表单渲染 -->
    <el-dialog
      append-to-body
...
import { getNewsDetail } from '@/api/verify/verifyNews'
...
export default {
  ...
  methods: {
    ...
    requestData() {
      ...
      reviewNews(this.rowId, this.form).then(res => {
