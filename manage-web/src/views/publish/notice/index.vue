<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="noticeTName" :show-overflow-tooltip="true" label="通告类型" align="center" />
      <el-table-column prop="author" :show-overflow-tooltip="true" label="作者" align="center" />
      <el-table-column width="135" :show-overflow-tooltip="true" prop="publishdate" align="center" label="发布日期" />
      <el-table-column prop="reviewstatusStr" :show-overflow-tooltip="true" align="center" label="审核状态" />
      <el-table-column
        label="审核详情"
        align="center"
      >
